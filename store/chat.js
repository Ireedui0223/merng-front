      ...
      chatlog: [
        {
          message: {
            attached: {
              url: "https://cdn.dribbble.com/users/881719/screenshots/8216873/media/04f390902dd8b77084567b9551f051b2.png",
              type: "image",
              size: "1020",
              title: "screenshot",
            },
        ...
        },
        {
          message: {
            attached: {
              url: ":http://localhost:3000/ce95ba69-e3d9-4c16-8287-a04e9d457faa%file",
              type: "application/vnd.openxmlformats-officedocument.presentationml.presentation",
              size: "42082653",
              title: "lab 8 19b1num0040 Munkh-Ireedui.ppt",
            },
...
export const mutations = {
  sentChat(state, payload) {
    ...
    console.log(payload.message.attached);
    state.friends.find((c) => c.id === payload.id).chatlog.push(chat);
  },
  removeChat(state, payload) {
    console.log("remove called");
    console.log(payload);
    var removedObject = state.friends
      .find((c) => c.id === payload.user, console.log(payload.user))
      .chatlog.splice(
        find((c) => c.message_id === payload.message),
        1
      );
    // find(
    //   (c) => c.message_id === payload.message,
